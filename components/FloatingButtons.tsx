...
const buttons = [
  {
    key: 'whatsapp',
    href: 'https://wa.me/79148866774',
    label: 'WhatsApp',
    icon: <WhatsAppIcon />,
    className: 'bg-[#25D366] hover:bg-[#20b958] shadow-[0_4px_20px_rgba(37,211,102,0.4)]',
    delay: 0,
  },
  {
    key: 'telegram',
    href: 'https://t.me/+79148866774',
    label: 'Telegram',
    icon: <TelegramIcon />,
    className: 'bg-[#2AABEE] hover:bg-[#1e96d1] shadow-[0_4px_20px_rgba(42,171,238,0.4)]',
    delay: 0.07,
  },
  {
    key: 'max',
