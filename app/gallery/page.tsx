  ...
  return (
    <>
      <Section>
        ...
        <SectionHeader title="Галерея работ" subtitle="Наши выполненные проекты" centered />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {content.gallery
            ...
            <motion.div
              ...
              className="relative group cursor-pointer overflow-hidden rounded-xl bg-slate-800 aspect-video"
