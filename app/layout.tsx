...
export const metadata: Metadata = {
  ...
  description:
    'Профессиональный ремонт и обслуживание холодильного оборудования в Иркутске. Торговое, промышленное холодильное оборудование, рефрижераторы, автокондиционеров. Выезд 24/7, гарантия до 1 года.',
  keywords:
